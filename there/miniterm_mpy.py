...
if os.name == 'nt':  # noqa
    ...
    import ctypes
    try:
        import colorama  # basic escape support win win32
    except ImportError:
        sys.stderr.write('WARNING: please install "colorama" for full support\n')
        colorama = None
    else:
        colorama.init()
            ...
            while True:
                ...
                if z == unichr(13):
                    ...
                    try:
                        ...
                        pass
                    sys.stderr.write('xxx {!r}\n'.format(code))
                elif z in unichr(0xe0):    # cursor keys, home/end
                    code = msvcrt.getwch()
                    try:
    ...
    def reader(self):
        ...
        try:
            while self.alive and self._reader_alive:
                ...
                if data == b'\x1b':
                    data += self.serial.read(self.serial.in_waiting)  # XXX hack
                if data:
                    if self.raw:
